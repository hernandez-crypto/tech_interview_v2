...
*/ /*
    ...
    Solution: A really easy solution could be to just iterate three times and make sure that a 
    linked list was at least 3 nodes long. If it is, then delete the 2nd node.s
